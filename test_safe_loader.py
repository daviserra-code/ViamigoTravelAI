...
def main():
    ...
    test_cities = {
        ...
        "Rome": {
            "bbox": (41.88, 12.46, 41.92, 12.52),  # Smaller bbox for faster test
    ...
    print(f"✅ Average per city: {total_places//successful_cities if successful_cities > 0 else 0}")
    ...
    if results:
        ...
        for name, desc in results:
            desc_preview = (desc[:60] + '...') if desc and len(desc) > 60 else (desc or 'No description')
            print(f"   • {name}")
