...
def generate_dynamic_details(context, city):
    ...
    # For Genova, create specific details
    elif city == 'genova' or city == 'genoa':
        genova_places = {
            'acquario': {
                'title': 'Acquario di Genova',
                'summary': 'Secondo acquario più grande d\'Europa con 12.000 esemplari marini.',
                'details': [
                    {'label': 'Apertura', 'value': '1992, rinnovato costantemente'},
                    {'label': 'Specie', 'value': '600 specie diverse, 12.000 esemplari'},
                    {'label': 'Vasche', 'value': '70 vasche tematiche su 3 piani'},
                    {'label': 'Delfini', 'value': 'Vasca delfini da 1,2 milioni di litri'},
                    {'label': 'Porto Antico', 'value': 'Parte del complesso turistico'},
                    {'label': 'Posizione', 'value': 'Area del Porto Antico'}
                ],
                'tip': 'Prenota online per evitare code. Biglietto combinato con Biosfera',
                'opening_hours': 'Lun-Ven 10:00-19:00, Weekend 9:30-20:00',
                'cost': '€29 adulti, €19 bambini'
            },
            'palazzo rosso': {
                'title': 'Palazzo Rosso, Genova',
                'summary': 'Residenza nobiliare del \'600 con collezioni d\'arte e affreschi barocchi.',
                'details': [
                    {'label': 'Costruzione', 'value': '1671-1677 per famiglia Brignole-Sale'},
                    {'label': 'Musei di Strada Nuova', 'value': 'UNESCO World Heritage'},
                    {'label': 'Collezioni', 'value': 'Van Dyck, Dürer, Veronese'},
                    {'label': 'Affreschi', 'value': 'Soffitti barocchi originali'},
                    {'label': 'Via Garibaldi', 'value': 'Strada Nuova rinascimentale'},
                ],
                'tip': 'Biglietto combinato con Palazzo Bianco e Palazzo Doria-Tursi',
                'opening_hours': 'Mar-Ven 9:00-19:00, Weekend 10:00-19:00',
                'cost': '€9 singolo, €15 combinato tre palazzi'
            },
            'via del campo': {
                ...
                'details': [
                    ...
                    {'label': 'Lunghezza', 'value': '500 metri nel centro storico'},
                    {'label': 'Fabrizio De André', 'value': 'Canzone "Via del Campo" (1967)'},
                    {'label': 'Caratteristiche', 'value': 'Negozi storici, botteghe artigiane'},
                    {'label': 'Specialità', 'value': 'Farinata, focaccia genovese'},
                    {'label': 'Mercato', 'value': 'Mercato orientale vicino'}
                ],
                'tip': 'Prova la farinata autentica nei forni storici',
                'opening_hours': 'Sempre accessibile, negozi 9:00-19:00',
                'cost': 'Gratuito'
            },
            'lanterna': {
                'title': 'Lanterna di Genova',
                'summary': 'Il faro simbolo di Genova e secondo faro più alto del mondo.',
                'details': [
                    {'label': 'Altezza', 'value': '117 metri (secondo faro più alto al mondo)'},
                    {'label': 'Costruzione', 'value': '1543, ricostruita più volte'},
                    {'label': 'Storia', 'value': 'Faro attivo da oltre 900 anni'},
                    {'label': 'Museo', 'value': 'Museo della Lanterna alla base'},
                    {'label': 'Vista', 'value': 'Panorama su porto e città'},
                    {'label': 'Simbolo', 'value': 'Emblema di Genova nel mondo'}
                ],
                'tip': 'Visita al tramonto per foto spettacolari. Museo interessante per la storia marittima',
                'opening_hours': 'Mar-Dom 14:30-18:30 (estate fino 19:30)',
                'cost': '€6 adulti, €4 ridotto, museo incluso'
            },
            'piazza de ferrari': {
                'title': 'Piazza De Ferrari, Genova',
                'summary': 'Il salotto di Genova, circondata da palazzi storici e dominata dalla fontana centrale.',
                'details': [
                    {'label': 'Fontana', 'value': 'Costruita nel 1936, ristrutturata nel 2001'},
                    {'label': 'Palazzo Ducale', 'value': 'Ex sede del governo della Repubblica'},
                    {'label': 'Teatro Carlo Felice', 'value': 'Teatro dell\'opera ricostruito'},
                    {'label': 'Shopping', 'value': 'Gallerie Mazzini, Via XX Settembre'},
                    {'label': 'Centro', 'value': 'Punto di partenza per visitare Genova'}
                ],
        ...
        # Try Genova places
        for key, details in genova_places.items():
            if key in place_name.lower() or key in context.lower():
                return details
    ...
    # Generic fallback for Genova attractions
    if city == 'genova' or city == 'genoa':
        return {
            'title': f'{place_name.title()}, Genova',
            'summary': f'Scopri questa attrazione nel capoluogo ligure, città marinara ricca di storia.',
            'details': [
                {'label': 'Città', 'value': 'Genova, Liguria'},
                {'label': 'Centro Storico', 'value': 'Patrimonio UNESCO dal 2006'},
                {'label': 'Porto', 'value': 'Primo porto italiano per traffico'},
                {'label': 'Caruggi', 'value': 'Labirinto di vicoli medievali'},
                {'label': 'Trasporti', 'value': 'Metro, bus, funicolari, ascensori'},
                {'label': 'Specialità', 'value': 'Pesto, focaccia, farinata'}
            ],
            'tip': 'Genova offre un mix unico di mare, storia e tradizioni culinarie',
            'opening_hours': 'Verificare orari specifici per ogni attrazione',
            'cost': 'Consultare tariffe aggiornate'
        }
